...
export const EmailTemplateModal = ({ visible, value, onChange, onCancel, onSave }) => {
  ...
  return (
    <View className="absolute inset-0 bg-black/50 justify-center items-center px-6">
      <View className="w-full rounded-2xl bg-card p-6">
        ...
        <Text className="mb-4 text-xs text-textSecondary font-sans">
          Use placeholders: {'{student}'}, {'{class}'}, {'{time}'}
        </Text>
        <TextInput
          value={value}
