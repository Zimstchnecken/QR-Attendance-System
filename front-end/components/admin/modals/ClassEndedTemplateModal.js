...
export const ClassEndedTemplateModal = ({ visible, value, onChange, onCancel, onSave }) => {
    ...
    <View className="absolute inset-0 bg-black/50 justify-center items-center px-6">
      <View className="w-full rounded-2xl bg-card p-6">
        <View className="mb-4 flex-row items-center justify-between">
          <Text className="text-lg font-bold text-textPrimary font-sans">Class Ended</Text>
        ...
        <TextInput
          ...
          placeholder="Enter class ended notification"
