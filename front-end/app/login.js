...
import { GraduationCap, LogIn, Mail, Shield, Lock } from "lucide-react-native";
      ...
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={styles.flex}>
        ...
        >
            ...
            <View className="flex-row items-center gap-3">
              ...
              <View>
                ...
                <Text className="mt-2 text-sm text-textSecondary font-sans">
                  Teacher access for session management
                </Text>
              </View>
            </View>
          </View>
          ...
          <GlassCard className="mb-6">
            ...
            <TouchableOpacity onPress={onSwitchToStudent} activeOpacity={0.9} className="mt-4">
              <View className="flex-row items-center justify-center gap-2">
