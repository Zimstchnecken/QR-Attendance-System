...
VALUES
  ('11111110-1111-1111-1111-111111111111', '11111111-1111-1111-1111-111111111111', NULL, 'ST-021', 'Alyssa', 'Cruz', 'Grade 10', 'Newton', '$2a$06$fake1hash', 'active'),
  ('11111111-1111-1111-1111-111111111110', '11111111-1111-1111-1111-111111111111', NULL, 'ST-034', 'Joshua', 'Lim', 'Grade 10', 'Newton', '$2a$06$fake2hash', 'active'),
  ('11111111-1111-1111-1111-111111111112', '11111111-1111-1111-1111-111111111111', NULL, 'ST-045', 'Maria', 'Garcia', 'Grade 10', 'Newton', '$2a$06$fake3hash', 'active'),
  ('11111111-1111-1111-1111-111111111113', '11111111-1111-1111-1111-111111111111', NULL, 'ST-056', 'Marco', 'Santos', 'Grade 11', 'Einstein', '$2a$06$fake4hash', 'active'),
  ('11111111-1111-1111-1111-111111111114', '11111111-1111-1111-1111-111111111111', NULL, 'ST-067', 'Sofia', 'Reyes', 'Grade 11', 'Einstein', '$2a$06$fake5hash', 'active'),
  ('11111111-1111-1111-1111-111111111115', '11111111-1111-1111-1111-111111111111', NULL, 'ST-078', 'Katrina', 'Santos', 'Grade 12', 'STEM A', '$2a$06$fake6hash', 'active'),
  ('11111111-1111-1111-1111-111111111116', '11111111-1111-1111-1111-111111111111', NULL, 'ST-089', 'Adrian', 'Flores', 'Grade 12', 'STEM A', '$2a$06$fake7hash', 'active'),
  ('11111111-1111-1111-1111-111111111117', '11111111-1111-1111-1111-111111111111', NULL, 'ST-090', 'Luna', 'Torres', 'Grade 12', 'STEM A', '$2a$06$fake8hash', 'active')
ON CONFLICT DO NOTHING;
