    ...
    <SafeAreaView className="flex-1 bg-brand-50">
      ...
      <ScrollView className="px-6 py-6">
        ...
        <GlassCard className="mb-5 items-center">
          <Text className="mb-3 text-sm font-semibold uppercase tracking-widest text-brand-700">QR Scanner</Text>
          <View className="h-64 w-full items-center justify-center rounded-3xl border-2 border-dashed border-brand-500 bg-white">
            <Text className="text-center text-lg font-semibold text-brand-700">Camera Preview</Text>
            <Text className="mt-2 text-center text-sm text-slate-500">Placeholder for QR scan component</Text>
          </View>
          <TouchableOpacity className="mt-4 w-full rounded-2xl bg-brand-700 px-4 py-4">
